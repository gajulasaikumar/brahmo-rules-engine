...
-- Organization
INSERT IGNORE INTO organizations (id, name, segment, config_json) VALUES
...
-- ============================================================
INSERT IGNORE INTO hierarchy_levels (id, org_id, level_number, level_name, department, parent_ids, zone) VALUES
...
INSERT IGNORE INTO knowledge_nodes (id, org_id, hierarchy_level_id, type, title, content, importance, zone, status, derivability_score, compliance_tags, department) VALUES
...
-- Edges
-- ============================================================
INSERT IGNORE INTO edges (id, source_id, target_id, edge_type) VALUES
('E-01', 'N-O02', 'N-O01', 'SUPPORTS'),
('E-02', 'N-O06', 'N-O01', 'SUPPORTS'),
('E-03', 'N-O09', 'N-O03', 'SUPPORTS'),
('E-04', 'N-G01', 'N-O14', 'SUPPORTS'),
('E-05', 'N-O03', 'N-O01', 'DERIVED_FROM'),
('E-06', 'N-O14', 'N-G01', 'DERIVED_FROM'),
('E-07', 'N-M02', 'N-M08', 'SUPERSEDES'),
('E-08', 'N-D01', 'N-O02', 'SUPPORTS'),
('E-09', 'N-O02', 'N-O06', 'REQUIRES'),
('E-10', 'N-C02', 'N-C01', 'REQUIRES');